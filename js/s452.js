...
// WR IDs of the subsystems that *should* be in the data stream, and will be shown as "error" if missing
var expected_subsystems = [ 0x100, 0x400, 0x500, 0x700, 0x1500, 0x1600 ];

SEETRAM_A =  208;          // Beam A
SEETRAM_Z =   82;          // Beam Z
SEETRAM_E = 1025;          // Beam E 
SEETRAM_R = 10.0 * 1.0E-9; // 10 nA full scale range
